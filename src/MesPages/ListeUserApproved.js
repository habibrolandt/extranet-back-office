...
function ListeUserApproved() {
    ...
    const fetchDemandes = async (activeFilters) => {
        ...
        const requestStatus = lastPart === "toutes" ? "process" : "enable";
...
export default ListeUserApproved;
